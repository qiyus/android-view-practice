	...
	public IndicatorProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		if (a != null) {
			m_textPaint.setTextSize(a.getDimension(
					R.styleable.progressIndicator_textSize, 10));
			m_textPaint.setColor(a.getColor(
					R.styleable.progressIndicator_textColor, Color.WHITE));

			int alignIndex = (a.getInt(R.styleable.progressIndicator_textAlign,
					1));
			if (alignIndex == 0) {
			...
			int textStyle = (a
					.getInt(R.styleable.progressIndicator_textStyle, 1));
			if (textStyle == 0) {
			...
			m_indicator = a
					.getDrawable(R.styleable.progressIndicator_progressIndicator);

			m_offset = (int) a.getDimension(
					R.styleable.progressIndicator_offset, 0);
